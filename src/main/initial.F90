...
subroutine startrun(infile,logfile,evfile,dumpfile,noread)
 ...
 use dim,              only:maxp,maxalpha,maxvxyzu,maxptmass,maxdusttypes,itau_alloc,itauL_alloc,icool_alloc,&
 ...
 use part,             only:npart,xyzh,vxyzu,fxyzu,fext,divcurlv,divcurlB,Bevol,dBevol,tau, tau_lucy, cool_rate,&
